...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="contacted" type="text"
                                            class="form-control"
                                            name="contacted" value="{{$value->contacted}}" disabled>
                                    </div>
                                </div>
                            </div>
            ...
            @else
            <div class="text-center">
            <img src="{{asset('storage/photos/Noimg.jpg')}}" width="200px" height="200px">
            @endif 
                                </div>
                        ...
                        {{ method_field('PUT') }}
                            ...
                            <select class="form-control {{ !empty( $errors->first('status')) ? 'is-invalid' : '' }}" name="status" id="status">
